...
# ASCII Art - AGE wordmark (constant names stay Hermes for internal compatibility)
...
[#CD7F32]██║  ██║╚██████╔╝███████╗[/]
[#CD7F32]╚═╝  ╚═╝ ╚═════╝ ╚══════╝[/]
[#B8860B]        AGE by Genesis Labs[/]"""

HERMES_CADUCEUS = """[bold #FFD700]      AGE[/]
[#FFBF00]AGE by Genesis Labs[/]
[#CD7F32]Customer onboarding harness[/]"""
...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        line1 = "AGE by Genesis Labs - AI Agent Framework"
        tiny_line = "AGE by Genesis Labs"
    else:
    ...
    if w < 30:
        return f"\n[{title_color}]{tiny_line}[/] [dim {dim_color}]- Genesis Labs[/]\n"
...
class HermesCLI:
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding("welcome", "Welcome to AGE by Genesis Labs! Type your message or /help for commands.")
            _welcome_color = _welcome_skin.get_color("banner_text", "#FFF8DC")
        except Exception:
            _welcome_text = "Welcome to AGE by Genesis Labs! Type your message or /help for commands."
